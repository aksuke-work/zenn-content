...
正確な手取り計算は [AND TOOLSの手取り計算ツール](https://and-tools.net/tools/take-home/) で試算できる。月単価を変えながら実質手取りを確認し、交渉の根拠にしてほしい。単価が決まったら [粗利計算ツール](https://webatives.com/tools/gross-profit-calc/) で経費を差し引いた実質利益も確認しておくと、採算ラインの把握に役立つ。
