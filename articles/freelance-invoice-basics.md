...
フリーランスとして登録すべきかの判断は、取引先の規模・税務上の影響・手続き負担を総合的に考える必要がある。[AND TOOLSのインボイス計算ツール](https://and-tools.net/tools/invoice/) で登録した場合の税負担を確認できる。請求書の作成自体は [無料の請求書作成ツール](https://webatives.com/tools/invoice/) でブラウザ上から行えるので、テンプレートを用意していない方にも役立つ。
